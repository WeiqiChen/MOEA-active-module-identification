...
% column meanings: V variables, M objective values, 0 for feasible, last column
% is the distance 
...
infpop=sortrows(infchromosome,[-(V+M+1),(V+1)]);
